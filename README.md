...
EPA stands for Expected Points Added. It measures how many points are added per play or drive, whichever metric you want to measure. It is a useful statistic because you can add value to counting stats. For example, a 6 yard completion will go down on the score sheet as a 6 yard pass, it doesn't take into account whether that was on 3rd
and 5, or 3rd and 10, or 2nd and 6 etc. EPA measures the context of the situation, a 6 yard completion on 3rd and 5 is more valuable than a 6 yard completion on 3rd and 10 because the completion on 3rd and 5 gives you a first down whereas the completion on 3rd and 10 gives you fourth down and a potential punt. The higher the EPA for an offense, the better they are. The same logiic can be applied to the defensive side of the ball. A tackle goes down on the score sheet as a tackle. However a touchdown saving tackle on the goal line is more valuable than a tackle on 1st and 10. The lower the EPA for a defense, the better they are. 
